...
const RU_TO_EN = {
  ...
  ,"Передайте номер досье и описание неточности через официальный Telegram-канал. Не отправляйте чувствительные сведения без необходимости.": "Send the record number and a description of the error through the official Telegram channel. Do not share sensitive information unless necessary."
