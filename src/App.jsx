...
function AdminPanel({ records, setRecords, mode, token, setToken }) {
  ...
  const sectionPermissions = {
    records: ["records.view", "records.create", "records.edit", "records.publish", "records.archive", "records.delete"],
    reception: ["reception.view", "reception.answer", "reception.moderate", "reception.publish", "reception.view_author"],
    support: ["support.view", "support.reply", "support.change_status", "support.view_private"],
    team: ["users.view", "users.assign_roles", "roles.view", "roles.create", "roles.edit", "roles.delete", "roles.assign", "roles.manage_permissions"],
    security: ["security.view_audit", "security.view_sessions", "security.revoke_sessions"],
  };
  ...
  return (
    <main className="admin-shell">
      ...
      {section === "reception" ? <AdminReceptionManager canModerate={has("reception.answer") || has("reception.moderate") || has("reception.publish")} canRevealAuthor={has("reception.view_author")} /> : section === "support" ? <AdminSupportManager token={token} canUpdate={has("support.reply") || has("support.change_status")} /> : section === "team" ? <AdminTeamManager /> : section === "security" ? <AdminSecurityCenter canRevoke={has("security.revoke_sessions")} /> : <section className="admin-card">
